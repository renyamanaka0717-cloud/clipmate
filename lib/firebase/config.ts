...
const firebaseConfig = {
  ...
  messagingSenderId: (process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '000000000000').trim(),
  appId: (process.env.NEXT_PUBLIC_FIREBASE_APP_ID || '1:000000000000:web:placeholder').trim(),
};
